...
public class ScrumitTestContainer extends TestContainer {

    public ScrumitTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/scrumit/app.properties",
    ...
    public static class Common extends ScrumitTestContainer {

        public static final ScrumitTestContainer.Common INSTANCE = new ScrumitTestContainer.Common();
