...
alter table SCRUMIT_TASK add constraint FK_SCRUMIT_TASK_ON_TRACKER_ID foreign key (TRACKER_ID_ID) references SCRUMIT_TRACKER(ID)^
...
create index IDX_SCRUMIT_TASK_ON_TRACKER_ID on SCRUMIT_TASK (TRACKER_ID_ID)^
-- end SCRUMIT_TASK
